var convert
  ...
  , each = _.each
  , measures = {
      length: length_exports
    , area: area_exports
    , mass: mass_exports
    , volume: volume_exports
    , each: each_exports
    , temperature: temperature_exports
    , time: time_exports
    , digital: digital_exports
    , partsPer: partsPer_exports
    , speed: speed_exports
    , pace: pace_exports
    , pressure: pressure_exports
    , current: current_exports
    , voltage: voltage_exports
    , power: power_exports
    , reactivePower: reactivePower_exports
    , apparentPower: apparentPower_exports
    , energy: energy_exports
    , reactiveEnergy: reactiveEnergy_exports
    , volumeFlowRate: volumeFlowRate_exports
    , illuminance: illuminance_exports
    , frequency: frequency_exports
    , angle : angle_exports
    };
